...
def showtrain_view(request):
	...
	try:
		...
		return render(request,'showTrains.html',c)
...
def train_view(request):
	...
	try:
		...
		if(source==destination):
			...
			return render(request,'invalidshowTrains.html',c)
		...
		if(count==0):
			...
			return render(request,'trains.html',c)
...
def booking_view(request):
	...
	try:
		...
		try:
			...
			return render(request,'finalbooking.html',c)
...
def booking_details(request):
	...
	try:
		...
		try:
			...
			return render(request,'bookingdetails.html',c)
